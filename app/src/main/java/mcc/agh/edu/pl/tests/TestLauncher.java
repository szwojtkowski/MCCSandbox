...
import mcc.agh.edu.pl.mobilecloudcomputinglibrary.decider.LinearRegressionDecider;
...
public class TestLauncher {
    ...
    public void launch(){
        ...
        Decider randomDecider = new RandomDecider();
        Decider decider = new LinearRegressionDecider(repository, algorithm);
        ...
        TestSuiteExecutor executor = new TestSuiteExecutor(testSuite, service);
        executor.execute();
    }
